...
- `input-manifest.yaml > execution_gate:` / `readme_discovery:` / `final_artifacts:` 슬롯 (frontmatter 동기용)
...
- manifest 슬롯: `templates/input-manifest.yaml > execution_gate:` / `readme_discovery:` / `final_artifacts:` / `two_doc_cross_check:`
