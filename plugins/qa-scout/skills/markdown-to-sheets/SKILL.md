...
| §1 기능 행 (17컬럼) | **03_기능정의서** (본체) | 03_기능정의서 | **03_기능정의서** (단일 17컬럼) | **03_기능정의서** (단일 18컬럼) |
| §2 비기능 요구 (9컬럼) | 04_비기능요구 | 04_비기능요구 | 이행 X | 이행 X |
| §3 사용자 스토리 (9컬럼) | 05_사용자스토리 | 05_사용자스토리 | 이행 X | 이행 X |
...
sheets:
  ...
  # 옵션 C는 03_기능정의서 단일 (17컬럼)
  # 옵션 D는 03_기능정의서 단일 (18컬럼, 인풋 출처 17번 매핑)
  # 06_18c_개발팀_질의 (include_optional=true 시 추가, 옵션 A/B 한정 — C·D는 미지원)
